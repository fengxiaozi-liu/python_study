...
def customer_list(request):
    ...
    :return:
    """
    numbers = models.Customer.objects.all().count()
    ...
    pager = Pagination(current_page=request.GET.get('page'),
                       ...
                       per_page=3)
    data_list = models.Customer.objects.all()[pager.start:pager.end]

    return render(request, 'customer_list.html', {'data_list': data_list, 'pager': pager})
